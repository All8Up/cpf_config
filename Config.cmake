hunter_config (cpf
    URL "https://github.com/All8Up/cpf_core/archive/v0.0.87.tar.gz"
    SHA1 7c568845c5ebf6f80f0f22c8838faeafe6aa580e
    CMAKE_ARGS
...
hunter_config (cpf_kpi
    ...
    SHA1 2848183a69b4e52b46def2a7113033cc9e7f6dc2
    CMAKE_ARGS
        CPF_CONFIG_VERSION=${CPF_CONFIG_VERSION}
        CPF_TOOLCHAINS_VERSION=${CPF_TOOLCHAINS_VERSION}
        BUILD_SHARED_LIBS=${CPF_BUILD_SHARED}
...
hunter_config (cpf_data
    ...
    SHA1 2801c556974d294b42a5e8ce4a63b59e0660b5f3
    CMAKE_ARGS
        CPF_CONFIG_VERSION=${CPF_CONFIG_VERSION}
        CPF_TOOLCHAINS_VERSION=${CPF_TOOLCHAINS_VERSION}
        BUILD_SHARED_LIBS=${CPF_BUILD_SHARED}
...
hunter_config (cpf_data_sqlite3
    ...
    SHA1 c352c1fe534d0b8b852a4490b9e39280bd2c5fbf
    CMAKE_ARGS
        CPF_CONFIG_VERSION=${CPF_CONFIG_VERSION}
        CPF_TOOLCHAINS_VERSION=${CPF_TOOLCHAINS_VERSION}
        BUILD_SHARED_LIBS=${CPF_BUILD_SHARED}
